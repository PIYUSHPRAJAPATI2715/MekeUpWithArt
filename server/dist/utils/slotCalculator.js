...
exports.getAvailableSlotsForDate = void 0;
const WorkingHours_1 = require("../models/WorkingHours");
const Holiday_1 = require("../models/Holiday");
const Booking_1 = require("../models/Booking");
const getAvailableSlotsForDate = async (dateStr, itemDurationMinutes = 30) => {
    // Check if date is holiday
    const holiday = await Holiday_1.Holiday.findOne({ date: dateStr, isFullDay: true });
    if (holiday) {
        return [];
    }
